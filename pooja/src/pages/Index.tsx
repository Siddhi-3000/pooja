...
const navItems = [
  ...
  { to: "/siddhi", label: "Siddhi", icon: Heart, gradient: "from-rose-200 to-pink-300" },
  { to: "/divin", label: "Divin", icon: Sparkles, gradient: "from-purple-200 to-pink-200" },
  ...
  return (
    <PageLayout>
          ...
          <div className="text-center md:text-left space-y-8 animate-fade-in-up">
            <div>
              ...
              <h1 className="font-serif text-5xl md:text-7xl leading-none">
                Turning <span className="text-gradient italic">19</span>
              </h1>
              <p className="mt-4 text-muted-foreground max-w-md mx-auto md:mx-0">
                Counting every moment until your magical day begins ✨
              </p>
            </div>
            <CountdownTimer />
          </div>
      ...
      <section className="px-6 md:px-12 py-16 text-center">
        ...
        <p className="mt-6 text-lg text-muted-foreground italic max-w-2xl mx-auto">
          "Another year of you — the world's softest blessing."
        </p>
